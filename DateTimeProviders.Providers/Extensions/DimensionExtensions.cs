...
namespace DateTimeProviders.Dimensions.Extensions;
...
public static class DimensionExtensions
{
    ...
    public static long ToMonthDimKey(this DateTime value)
    {
    ...
    /// <param name="value">the date time</param>
    /// <returns>a long</returns>
    public static long ToDateDimKey(this DateTime value)
    {
        return (value.ToMonthDimKey() * 100) + value.Day;
    }
    ...
    {
        if (DateTime.TryParseExact($"{value}", "yyyyMM", CultureInfo.InvariantCulture, DateTimeStyles.AssumeLocal,
                out var result))
        {
            return result;
        }
    ...
    {
        if (DateTime.TryParseExact($"{value}", "yyyyMMdd", CultureInfo.InvariantCulture, DateTimeStyles.AssumeLocal,
                out var result))
        {
            return result;
        }
