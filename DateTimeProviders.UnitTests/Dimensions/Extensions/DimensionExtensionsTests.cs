...
public class DimensionExtensionsTests
{
    ...
    [Fact]
    public void Test_FromMonthDimKey_Fail()
    {
        Assert.Throws<ArgumentException>(() => (201900L).FromMonthDimKey());
    }
    ...
    [Fact]
    public void Test_FromDateDimKey_Fail()
    {
        Assert.Throws<ArgumentException>(() => (20190004L).FromDateDimKey());
    }
